...
<div class="p-6">
	...
	<div class="mb-6 grid gap-6 md:grid-cols-2 lg:grid-cols-4">
		...
		<div class="rounded-lg border border-gray-200 bg-white p-6">
			<div class="flex items-center justify-between">
				<div>
					<div class="text-sm font-medium text-gray-500">Top Referrers</div>
							...
							{#each data.analytics.topReferrers as referrer, index}
								<div class="flex items-center justify-between">
									<div class="flex items-center gap-3">
										...
										<div>
											<div class="max-w-32 truncate text-sm font-medium text-gray-900">
												{referrer.domain}
											</div>
									...
									<div class="text-sm font-medium text-gray-900">{referrer.views}</div>
								</div>
							{/each}
						</div>
					{:else}
						<div class="py-8 text-center">
							...
							<h3 class="mb-1 text-sm font-medium text-gray-900">No referrers yet</h3>
							<p class="text-xs text-gray-500">Traffic sources will appear here</p>
						</div>
					{/if}
				</div>
			</div>
